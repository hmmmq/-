            ...
            <template v-for="(item, index) in itemList" :key="index">
              <nav class="navbar navbar-light row navbar-expand-md">
                ...
                <button id="nav-toggle" type="button"
                  class="ui-navbar-toggler navbar-toggler border-0 p-0 mr-md-0 ml-auto" data-toggle="collapse"
                  data-target=".navbar-24991" aria-expanded="false" aria-label="Toggle navigation">
