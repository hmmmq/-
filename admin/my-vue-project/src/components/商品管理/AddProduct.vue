      ...
      <div class="row justify-content-center">
        <div class="productd col-lg-12">
          <div class="productd-body">
            <div class="productd-title text-primary">添加商品</div>
            <hr />
            <form>
...
export default {
  ...
  methods: {
    checknullvalue() {
    //判空
    // Check if the necessary fields are empty or null
    if (!this.product.productName || !this.product.price || !this.product.description || this.selectedFile==null) {
      alert("请填写完整信息或上传图片");
      return false; // Prevent further actions
    }
    return true; // If all fields are valid, allow further actions
  },
  // methods
  submit() {
    console.log("submit");
